...
public class ManageLocationReportsAdapter extends ArrayAdapter<Report> {
    ...
    public ManageLocationReportsAdapter(@NonNull Context context, ArrayList<Report> reportArrayList) {
