...
public class ReportNotificationListViewHolder extends RecyclerView.ViewHolder {

    public CircleImageView user_reported_image;
    public TextView user_report_name, user_report_description, user_report_time;

    public ReportNotificationListViewHolder(@NonNull View notificationItemView, RecyclerViewInterface recyclerViewInterface) {
