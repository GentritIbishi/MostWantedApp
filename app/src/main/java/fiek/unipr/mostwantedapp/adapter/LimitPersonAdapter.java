...
public class LimitPersonAdapter extends ArrayAdapter<Person> {
    ...
    public LimitPersonAdapter(@NonNull Context context, ArrayList<Person> limit_personArrayList) {
        super(context, 0, limit_personArrayList);
    }
